        ...
        switch (req.body.type) {
            case 'EMAIL-SEND':
                try {
                    ...
                    const signatureImagePath = path.join(process.cwd(), 'public', 'images', `signature.jpg`);
                    doc.image(signatureImagePath, 250, y - 20, { width: 106, height: 31 });
                    ...
                    const htmlContent = `<div>
                                            ...
                                            <div></div>
                                            <span>Team Seeds & Feeds VYANAH.</span>
                                            <p style="margin-top:1px">
                                                504, SYNERGY, KACH PADA RD NO. 2, NEAR MALAD IND. ESTATE, RAMCHANDRA LANE EXTENTION, MALAD (W), MUMBAI - 400 064
                                                <br>
                                                Tel. : 022 2880 2452-Fax : 022 2881 5002
                                                <br />
                                                Email : <a href="mailto:kashyap.seedsnfeeds@gmail.com" target="_blank">kashyap.seedsnfeeds@gmail.com</a>
                                            </p>
                                        </div>
                                    `;
