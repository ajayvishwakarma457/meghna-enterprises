...
import { Container, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Button, Typography, TextField, } from "@mui/material";
  ...
  const donwloadPdfHandler = async () => {
    ...
    try {
      ...
      if (response.data.message) {
        ...
        tempLink.href = "/pdf/billing.pdf";
        tempLink.target = "_blank";
        tempLink.rel = "noopener noreferrer";
        tempLink.download = "/pdf/billing.pdf";
      ...
      <Container maxWidth="xl">
        ...
        <div className="header-content">
          ...
          <div className="btn-wrapper report">
            <div>
              <div><TextField  id="start-date" variant="outlined" type="date" value={startDate} onChange={(e) => setStartDate(e.target.value)} /></div>
              <div><TextField id="end-date" variant="outlined" type="date" value={endDate} onChange={(e) => setEndDate(e.target.value)} /></div>
              <div><Button variant="contained" className="filter-btn" onClick={handleFilter}>Filter</Button></div>
            </div>
            <div>
